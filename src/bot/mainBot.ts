import { Collection, createBot, DISCORDENO_VERSION, LogDepth, logger } from "@discordeno/bot";
import { ManagerGetShardInfoFromGuildId, ShardInfo, WorkerPresencesUpdate, WorkerShardPayload } from "../gateway/worker/types";
import { DISCORD_TOKEN, GATEWAY_AUTHORIZATION, GATEWAY_INTENTS, GATEWAY_URL, REST_AUTHORIZATION, REST_URL } from "../config";
...
export default function mainBot() {
    ...
    type CustomBot = typeof rawBot & {
      commands: Collection<string, Command>;
    };
  
    const bot = rawBot as CustomBot;
